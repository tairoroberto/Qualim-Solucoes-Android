...
public class RelatoriosVisualCheckListActivity extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorios_visualiza_checklist);

        // mostra o logo do app na actionbar
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle("Visualizar check list");
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
                RelatoriosVisualCheckListActivity.this,    /* Classe que chama a activity Activity */
    ...
    private class SearchFiltro implements SearchView.OnQueryTextListener {
        ...
        public boolean onQueryTextSubmit(String query) {
            ...
            if (intent.resolveActivity(getPackageManager()) != null) {
                ...
                Toast.makeText(RelatoriosVisualCheckListActivity.this, R.string.app_not_available, Toast.LENGTH_LONG).show();
            }
            return false;
        }
    }
    ...
    private void selectItemLeft(int position) {
        ...
        if (position == 0) {
            ...
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,PrincipalActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        } else if (position == 1) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,TarefasVisualizarActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 2) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,CronogramaInserirActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 3) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,CronogramaVerActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        } else if (position == 4) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,RelatoriosCadastVisitaTecActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 5) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,RelatoriosVisualVisitaTecActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 6) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,RelatoriosCadastAuditoriaActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 7) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,RelatoriosVisualAuditoriaActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 8) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,RelatoriosCadastCheckListActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 9) {
           /* Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,RelatoriosVisualCheckListActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);*/

        }else if (position == 10) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,PrestacaoContasInserirActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 11) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,PrestacaoContasVerActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 12) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,PerfilAlterarFotoActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 13) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,PerfilAlterarAssinaturaActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 14) {
            Intent intent = new Intent(RelatoriosVisualCheckListActivity.this,PerfilAlterarSenhaActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);
        }
    ...
    public void sendLogout(){
        final ProgressDialog progress = new ProgressDialog(RelatoriosVisualCheckListActivity.this);
                        ...
                        try{
                            if (answer != null){
                                if (!answer.equals("Ainda conectado")){
                                    ...
                                    progress.dismiss();
                                    Toast.makeText(RelatoriosVisualCheckListActivity.this, "Ainda conectado..!!!", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
