...
public class RelatoriosCadastAuditoriaActivity extends ActionBarActivity{
    ...
    private void selectItemLeft(int position) {
        ...
        if (position == 0) {
            ...
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,TarefasVisualizarActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 2) {
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,CronogramaInserirActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 3) {
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,CronogramaVerActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);
            ...
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,RelatoriosVisualVisitaTecActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);
            ...
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,PerfilAlterarFotoActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 13) {
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,PerfilAlterarAssinaturaActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);

        }else if (position == 14) {
            Intent intent = new Intent(RelatoriosCadastAuditoriaActivity.this,PerfilAlterarSenhaActivity.class);
            intent.putExtra("usuarioLogado",usuarioLogado);
            startActivity(intent);
        }
